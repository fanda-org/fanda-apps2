...
namespace Fanda.Accounting.Domain.Migrations.MySQL
{
    ...
    [Migration("20201106021100_AcctMySQL04")]
    partial class AcctMySQL04
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fanda.Accounting.Domain.PartyType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Fanda.Accounting.Domain.Party", b =>
                {
                    ...
                    b.HasOne("Fanda.Accounting.Domain.Organization", "PartyOrganization")
                        .WithOne("OrgParty")
                        .HasForeignKey("Fanda.Accounting.Domain.Party", "PartyOrgId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Fanda.Accounting.Domain.PartyType", "Type")
                        .WithMany("Parties")
